...
def listar_controles():
    ...
    return render_template("control/lista_control.html",controles=controles,secuencia=secuencia,form=form)
    ...
    if form.validate_on_submit():
        ...
        if ultimo!=None:
            ...
            try:
                ...
                flash(f"Ocurrio un error:{e}","error")
    return render_template("control/lista_control_ruta.html",form=form,secuencias=secuencias,rutas=rutas)
