...
class Viaje(db.Model):
    ...
    # Relaciones 
    ruta=db.relationship("Ruta",back_populates="rutas_viajes",uselist=False,single_parent=True)
    fecha=db.relationship("Fecha",back_populates="fechas_viajes",uselist=False,single_parent=True)
    vehiculo=db.relationship("Vehiculo",back_populates="vehiculos_viajes",uselist=False,single_parent=True)
