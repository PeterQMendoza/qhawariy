...
class ProximaRuta(db.Model):
    ...
    actual=db.relationship("Ruta",foreign_keys=[id_ruta],uselist=False,single_parent=True)
    proxima=db.relationship("Ruta",foreign_keys=[id_ruta2],uselist=False,single_parent=True)
