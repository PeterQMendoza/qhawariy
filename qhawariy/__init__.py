...
def create_app(test_config=None):
    ...
    login_manager.login_message=(u"No puedes realizar esta accion sin no has iniciado sesion")
    ...
    #   flask db stamp: Establece la revision en BD en la dada como argumento, sin realizar migracion.
    db.init_app(app)
...
def register_error_handler(app):
    """
        Manejadores errores de codigo de respuestas HTTP, para ser nostrados en la interfaz 
        grafica. De acuerdo a los codigos de estado y descritas de la siguiente manera:
    ...
    def error_401_handler(e):
        """
            Mostrada en situaciones en donde la autentificacion es posible pero ha fallado
            o aun no ha sido provista
        """
